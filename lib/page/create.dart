...
class _CreatePageState extends State<CreatePage> {
  ...
  Future<PasswordData> generatePasswordDataAuto() async {
    ...
    return PasswordData(
        id: Utilities.randomID().toString(),
  ...
  Widget favButton() {
    return TextButton(
        style: TextButton.styleFrom(
            ...
            elevation: 3,
            backgroundColor:
                isFavorite == 0 ? StyleColor.white : StyleColor.red,
        ...
        child: Icon(
          Icons.favorite,
          color: isFavorite == 1 ? StyleColor.white : StyleColor.red,
          size: 30,
        ));
  }
    ...
    return TextButton(
        ...
        onPressed: () async {
          if (checkAllValid()) {
            ...
            PasswordData password = await generatePasswordDataAuto();

            await PasswordsTB.addPassword(password);
            if (mounted) {
            ...
            decoration: InputDecoration(
                suffixIcon: Row(
                  ...
                  children: [
                    IconButton(
                        onPressed: () async {
                          Object result = Utilities.randomPassword(
                              hasLowerCase,
                              hasUpperCase,
                              hasNumbers,
                              hasSymbols,
                          ...
                          if (mounted) {
                            setState(() {
                              if (result != false) {
                                password_controller.text = result as String;
                              } else {
